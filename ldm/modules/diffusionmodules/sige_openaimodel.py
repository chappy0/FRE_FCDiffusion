...
from .openaimodel import ResBlock, TimestepBlock, TimestepEmbedSequential, UNetModel_sige
...
class SIGEUNetModel(SIGEModel, UNetModel_sige):
    def __init__(
        self,
        image_size,
        in_channels,
        ...
        super(UNetModel_sige, self).__init__()
